...
export default function Home() {
  return (
    <main>
      {/* <div className='my-1 md:my-6 mx-2 md:mx-10'><Accordian /></div> */}
      <div className='my-1 md:my-6 mx-2 md:mx-10'><Carousel /></div>
      ...
      <div className="m-2 md:m-10 flex items-center"><Picture1 /></div>
      <div><Cards2 /></div>
      <div><Reviews /></div>
      <div><OurWork /></div>
      <div><Plans /></div>
